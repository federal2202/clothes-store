    ...
    return (
        <header className='z-20 sticky top-0 flex items-center w-full py-4 px-4 md:px-16 lg:px-28 font-semibold text-[14px] lg:text-[16px] border-b-[1px] border-gray-400/30 font-geist backdrop-blur-sm bg-black/30'>
            <nav className='flex justify-between items-center w-full'>
                <div className='flex justify-start items-center gap-6 md:gap-8 lg:gap-10 tracking-wide font-semibold text-[14px]'>
                    <Link href="/" className='text-white text-lg drop-shadow-[0_0_1px_rgba(255,255,255,0.6)]'>FNclothes</Link>
                    ...
                    <Link href="/" className='text-[#fafafa99] relative hover:text-white transition duration-300'>Shipping <span className='absolute top-0 right-0 w-[1px] h-[1px] font-normal'><GoArrowUpRight /></span></Link>
                    <Link href="/" className='text-[#fafafa99] relative hover:text-white transition duration-300'>About Us <span className='absolute top-0 right-0 w-[1px] h-[1px] font-normal'><GoArrowUpRight /></span></Link>
                </div>
